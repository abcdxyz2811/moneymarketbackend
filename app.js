...
app.use(cors())
mongoose.connect("mongodb+srv://gakta:gakta123@cluster0.qtlcm.mongodb.net/trading?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true }).then(()=>{console.log("mongodb connection successfull")})
